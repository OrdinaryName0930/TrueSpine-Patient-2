...
import com.brightcare.patient.ui.component.chirocomponents.ChiroFilterChips
```
...
Note: The folder is named `ChiroComponents` (without hyphens) to comply with Android/Kotlin package naming conventions.